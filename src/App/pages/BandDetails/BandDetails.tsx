...
import BandSwiper from "../../../components/BandSwiper";
        ...
        <div className={styles.bandDetails}>
            <div className={styles.bandBio}>
                <div className={styles.bandInfo}>
                    ...
                    {!band.isActive && <Text><strong>Год распада:</strong> {band.endYear}</Text>}
                    <Text>
                        <strong>Жанры: </strong>
                ...
                <div className={styles.bandImageAndLinks}>
                    <BandSwiper images={band.imagesSwiper || [band.image]} alt={band.name}/>
